...
Usage:
    python scripts/lwh_apply_rulesets.py                 # apply every ruleset
    python scripts/lwh_apply_rulesets.py --dry-run        # print the JSON, do nothing
    python scripts/lwh_apply_rulesets.py --repo OWNER/REPO --dry-run
...
LEAPWare-Helm's own first apply (LWH-D0): the fix is to run the repo
