...
Usage:
    python scripts/lwt_apply_rulesets.py                 # apply every ruleset
    python scripts/lwt_apply_rulesets.py --dry-run        # print the JSON, do nothing
    python scripts/lwt_apply_rulesets.py --repo OWNER/REPO --dry-run
...
LEAPWare-TokenWise's own first apply (LWT-D0): the fix is to run the repo
