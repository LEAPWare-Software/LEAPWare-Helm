...
Usage:
    python scripts/lwt_check_commit_identity.py [--base <ref>] [--head <ref>]
...
Stdlib only. Exits 0 and prints "lwt-commit-identity check passed" on
...
def main() -> int:
    ...
    if findings:
        ...
        return 1
    print("lwt-commit-identity check passed")
    return 0
